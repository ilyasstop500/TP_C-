...
// definition des constructors
    ...
    commande::Commande::Commande(client::Client& client, bool confirmation, std::vector<product::Product> products, int id ) : _client(&client) , _confirmation(confirmation),_products(products),_id(id){
       };
...
// definition des setters
    ...
    void commande::Commande::setconfirmation(bool confirmation){ _confirmation = confirmation;}
...
// defenition des getteurs getters
    ...
    bool commande::Commande::getconfirmation() const { return _confirmation;}
